    ...
    for i in range(len(urlbiglist)):
        for j in range(len(urlbiglist[i])):
            ...
            for line in filecontent.splitlines():
                if not line.split():
                    continue
                line = line.rstrip() #只去空行   让其成为一行大的字符串
            ...
            # if ( len(p1)):
            #     continue
            # p2 = pagecontent.xpath('//div[@id = "main_content"]//p//text()')
            # print "第二次找"
            # print p2
            # for l in range(len(p2)):
            #     print '打印每一页的内容====='
            ...
            # if ( len(p2)):
            #     continue
            # p3 = pagecontent.xpath('//div[@class = "content-box"]//p//text()')
            # print "找到"
            # print p3
